        ...
        <div style="padding: 30px;">
          ...
          <div style="background-color: #fff3cd; border: 1px solid #ffeaa7; border-radius: 5px; padding: 15px; margin: 20px 0;">
            <p style="font-size: 14px; color: #856404; margin: 0; font-weight: bold;">
              ⏰ <strong>Importante:</strong> Este enlace expira en 15 minutos por seguridad.
            </p>
          </div>
  ...
  const info = await transporter.sendMail({
    ...
    <div style="font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 30px;">
      <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 30px;">
          <p style="font-size: 16px; color: #333;">Hola <strong>${name}</strong>,</p>
          <p style="font-size: 16px; color: #333;">Has solicitado restablecer tu password en <strong>AppSalon</strong>. Para finalizar, por favor restablece tu password haciendo clic en el siguiente botón:</p>
          <div style="text-align: center; margin: 30px 0;">
          ...
          <p style="font-size: 14px; color: #666;">Si tú no solicitaste restablecer tu password, puedes ignorar este mensaje.</p>
        </div>
        <div style="background-color: #f0f0f0; padding: 20px; text-align: center; font-size: 12px; color: #999;">
          © ${new Date().getFullYear()} AppSalon. Todos los derechos reservados.
        </div>
