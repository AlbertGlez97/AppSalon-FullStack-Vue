...
<template>
  <h2 class="text-4xl font-extrabold text-white mt-10">Mis Citas Pasadas</h2>
  <p class="text-white text-lg mt-5">A continuacion podras visualizar tus citas pasadas</p>
